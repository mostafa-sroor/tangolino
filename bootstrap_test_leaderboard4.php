...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <a href="https://goo.gl/iLXJe6" target="_blank">https://goo.gl/iLXJe6</a>

            <script src="https://code.jquery.com/jquery-3.2.1.min.js"></script>
            <script>
                var jqxz19872 = $.noConflict();
                jqxz19872(document).ready(function(){
                    var token  = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiIxNzQiLCJhdWQiOiJhZG1pblwvbG9va1wvYVwvc2hvcHBhYmxlY29udGVudCIsImlhdCI6MCwibmJmIjoxNTA2NTA3NDM3fQ.PbkFhGLYy8MYL99eyf7sSrV_Y6-SHHLBaLYa33gYl4Y";
                    var url    = "https://tview.tangolino.com/admin/look/a/shoppable-content";
                    var format         = "Leaderboard";
                    var collage_type   = "Collage-Widget";
                    var logo    = "https://tview.tangolino.com/uploads/catalog/croppedImg_1222750345.png";
                    var background    = "https://tview.tangolino.com/uploads/catalog/croppedImg_1661887668.png";
            ...
            <div id="block_content_ads"
                 style="  z-index:190000000 ; position: relative;">
            </div>
