...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <a href="https://goo.gl/DbDzZ1" target="_blank">https://goo.gl/DbDzZ1</a>
            ...
            <script>
                ...
                jqxz19872(document).ready(function(){
                    var token  = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiIxNzciLCJhdWQiOiJhZG1pblwvbG9va1wvYVwvc2hvcHBhYmxlY29udGVudCIsImlhdCI6MCwibmJmIjoxNTA2NTExMDc5fQ.o-sriMSoSj0444vTVbCLOzFjDO0FcP4FXLBqTw-te1k";
                    var url    = "https://tview.tangolino.com/admin/look/a/shoppable-content";
                    var format         = "Leaderboard";
                    var collage_type   = "Collage-Widget";
                    var logo    = "https://tview.tangolino.com/uploads/catalog/croppedImg_426134238.png";
                    var background    = "https://tview.tangolino.com/uploads/catalog/croppedImg_1372776554.png";
            ...
            <div id="block_content_ads" style="  z-index:190000000 ; position: relative;">
            </div>
