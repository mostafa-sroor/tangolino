...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Tagged Photo Widget Preview (Vertical)</title>
    <link rel="stylesheet" href="http://dhbhdrzi4tiry.cloudfront.net/cdn/sites/foundation.min.css">
  </head>
  <body>

  <iframe height="100%" width="100%" allowfullscreen="" frameborder="0"   id="collage_widget" src="https://tview.tangolino.com/admin/look/a/shoppable-content/?collage_type=Collage-Widget&token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiIxNzkiLCJhdWQiOiJhZG1pblwvbG9va1wvYVwvc2hvcHBhYmxlY29udGVudCIsImlhdCI6MCwibmJmIjoxNTA2MzMzNTg2fQ.9BI7yLn0wEmUE5_AwPfU2-MOHcc-NhvpZG6HIaSFQR4&logo=https://tview.tangolino.com/uploads/catalog/croppedImg_505947421.jpeg&format=Skyscraper&background=https://tview.tangolino.com/uploads/catalog/croppedImg_2099806507.png"></iframe>
  <script>
      document.getElementById('collage_widget').src = document.getElementById('collage_widget').src + "&host="+ window.location.host+ "&width="+ parent.document.body.clientWidth;
  </script>
